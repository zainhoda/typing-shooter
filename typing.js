	...
	return _Utils_Tuple2(
		{
			...
			enemyPosition: 5,
			numFound: 0,
			sentenceStartTime: $elm$core$Maybe$Nothing,
			totalWPM: 0,
			whichWord: 0,
			wordStartTime: $elm$core$Maybe$Nothing
		},
...
var $author$project$Main$NextWord = {$: 'NextWord'};
var $author$project$Main$StartTime = function (a) {
	return {$: 'StartTime', a: a};
};
var $author$project$Main$WordEndTime = function (a) {
	return {$: 'WordEndTime', a: a};
};
...
var $author$project$Main$getMysteryWord = function (model) {
	var _v0 = $elm$core$List$head(
		A2($elm$core$List$drop, model.whichWord, model.allSentences));
	if (_v0.$ === 'Nothing') {
		return '';
	} else {
		var word = _v0.a;
...
var $author$project$Main$getCurrentLetter = function (model) {
	...
	return A2(
		...
		_Utils_chr(' '),
		$elm$core$List$head(
			A2($elm$core$List$drop, model.numFound, charList)));
};
...
var $author$project$Main$getTime = function (msg) {
...
var $author$project$Main$splitWords = function (sentence) {
	return A2(
...
var $author$project$Main$getWPM = F3(
	function (sentence, maybeStart, end) {
		if (maybeStart.$ === 'Nothing') {
			return 0;
		} else {
			var start = maybeStart.a;
			var startMillis = $elm$time$Time$posixToMillis(start);
			var endMillis = $elm$time$Time$posixToMillis(end);
			var elapsedWords = A2(
				$elm$core$Debug$log,
				'elapsedWords',
				$elm$core$List$length(
					$author$project$Main$splitWords(sentence)));
			var elapsedMillis = A2($elm$core$Debug$log, 'elapsedMillis', endMillis - startMillis);
			var elapsedSeconds = A2($elm$core$Debug$log, 'elapsedSeconds', elapsedMillis / 1000);
			return A2($elm$core$Debug$log, 'getWPM', (60 * elapsedWords) / elapsedSeconds);
		}
	});
			...
			switch (_v0.$) {
				case 'StartTime':
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								sentenceStartTime: $elm$core$Maybe$Just(time),
								wordStartTime: $elm$core$Maybe$Just(time)
							}),
						$elm$core$Platform$Cmd$none);
				case 'WordEndTime':
					var time = _v0.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								currentWPM: A3($author$project$Main$getWPM, 'word', model.wordStartTime, time),
								enemyHp: model.enemyHp - $elm$core$Basics$round(
									A3($author$project$Main$getWPM, 'word', model.wordStartTime, time) * model.dpwpm),
								totalWPM: A3(
									$author$project$Main$getWPM,
									A2(
										$elm$core$String$left,
										model.numFound,
										$author$project$Main$getMysteryWord(model)),
									model.sentenceStartTime,
									time),
								wordStartTime: $elm$core$Maybe$Just(time)
							}),
						$elm$core$Platform$Cmd$none);
				...
				case 'NextWord':
					var newModel = (_Utils_cmp(
						$elm$core$List$length(model.allSentences),
						model.whichWord + 1) > 0) ? _Utils_update(
						model,
						{whichWord: model.whichWord + 1}) : _Utils_update(
						model,
						{whichWord: 0});
					return _Utils_Tuple2(
						_Utils_update(
							...
							{draft: '', numFound: 0}),
						$author$project$Main$sendMessage(
							$author$project$Main$getMysteryWord(newModel)));
				case 'Typed':
					var c = _v0.a;
					if (_Utils_cmp(
						model.numFound + 1,
						$elm$core$String$length(
							$author$project$Main$getMysteryWord(model))) > 0) {
						...
						if (_Utils_eq(
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{draft: '', numFound: model.numFound + 1}),
								(!model.numFound) ? $author$project$Main$getTime($author$project$Main$StartTime) : (_Utils_eq(
									c,
									_Utils_chr(' ')) ? $author$project$Main$getTime($author$project$Main$WordEndTime) : $elm$core$Platform$Cmd$none));
						} else {
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										draft: $elm$core$String$fromChar(c),
										enemyPosition: model.enemyPosition - 1
									}),
								$elm$core$Platform$Cmd$none);
						}
					}
					...
					return function (letter) {
						return (_Utils_eq(i, numberFound) && (guess !== '')) ? A2(
							...
							_List_fromArray(
								...
								])) : ((_Utils_cmp(i, numberFound) < 0) ? (_Utils_eq(
							letter,
							_Utils_chr(' ')) ? A2(
							$elm$html$Html$div,
							_List_fromArray(
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Typing Shooter')
							])),
						A3(
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								'Total WPM: ' + $elm$core$String$fromFloat(model.totalWPM))
							])),
						A2(
						$elm$html$Html$h1,
						_List_fromArray(
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								'Current WPM: ' + $elm$core$String$fromFloat(model.currentWPM))
							])),
						A2(
						$elm$html$Html$h1,
						_List_fromArray(
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								'DPWPM: ' + $elm$core$String$fromFloat(model.dpwpm))
							])),
						A2(
						$elm$html$Html$h1,
						_List_fromArray(
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								'Enemy HP: ' + $elm$core$String$fromInt(model.enemyHp))
							])),
						A2(
						$elm$html$Html$h1,
						_List_fromArray(
...
var $author$project$Main$view = function (model) {
	return $author$project$Main$mysteryWordView(model);
};
